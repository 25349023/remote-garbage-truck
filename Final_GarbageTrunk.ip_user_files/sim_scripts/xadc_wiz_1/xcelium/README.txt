...
#
# Generated by export_simulation on Tue Jan 07 11:25:44 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './xadc_wiz_1.sh' script.

./xadc_wiz_1.sh -reset_run
...
./xadc_wiz_1.sh -noclean_files

For more information on the script, please type './xadc_wiz_1.sh -help'.
