...
#set_property PACKAGE_PIN V17 [get_ports {rate}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {rate}]
#set_property PACKAGE_PIN V16 [get_ports {sw_stop}]					
...
#Pmod Header JA
#Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {sw}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {sw}]
#Sch name = JA2
...
#Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {ena}]					
...
#Sch name = JC3
#set_property PACKAGE_PIN N17 [get_ports {enb}]					
...
#Sch name = XA3_N
#set_property PACKAGE_PIN M1 [get_ports {sw}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw}]
#Sch name = XA4_N
